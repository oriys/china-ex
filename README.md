...
浙江默认标记为“居住”；江苏、福建、香港、广东、上海默认标记为“游玩”。

本站由 GitHub Pages 自动构建和发布。

当前页面不显示分数和外链，也不能选择文字或修改足迹。首页和省内城市均使用真实行政区轮廓；点击任意省级区域可以查看其下属城市地图：杭州、宁波标记为“居住”；嘉兴、湖州、绍兴、舟山、台州、上海中心城区、福州、厦门、泉州、广州、深圳、南京、无锡、常州、苏州标记为“游玩”。香港保持整体“游玩”。
